...
export default class Collection {
  ...
  async search(
    ...
    return result.docs.map(this.transformOfFirebase) ?? []
  }
  ...
  async searchById(path: string, id: string): Promise<any> {
    ...
    return this.transformOfFirebase(result)
  }
  ...
  private transformOfFirebase(snapshot: DocumentSnapshot<DocumentData>) {
