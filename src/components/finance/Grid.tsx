import {
  Transition,
  TypeTransition,
} from '@/logic/core/interface/TypeTransition'
import DateFormatter from '@/logic/utils/Data'
import Money from '@/logic/utils/Money'
import { IconTrendingDown, IconTrendingUp } from '@tabler/icons-react'

interface GridProps {
  transactions: Transition[]
  selectTransaction?: (transaction: Transition) => void
}

export default function Grid({ transactions, selectTransaction }: GridProps) {
  function renderItem(transaction: Transition) {
    return (
      <div
        className={`
      ...
      >
        <div
          className={`
                    ...
                    ${transaction.type === TypeTransition.RECEITA
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="z-10 font-light text-xs opacity-75">
            {DateFormatter.ddmm.formatar(transaction.data)}
          </span>
        </div>
